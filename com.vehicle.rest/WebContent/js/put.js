...
//			, VEHICLE_REGS_FIRST_REG = $tr.find('.CL_ VEHICLE_REGS_FIRST_REG').text();
//		
...
//		$('#SET_VEHICLE_REGS_MANU_YEAR').val(VEHICLE_REGS_MANU_YEAR);
//		$('#SET_VEHICLE_REGS_OWNER_FIRST_NAME').text(VEHICLE_REGS_OWNER_LAST_NAME);
//		$('#SET_VEHICLE_REGS_OWNER_LAST_NAME').text(VEHICLE_REGS_OWNER_LAST_NAME);
...
//		
//		updateInventory(obj, VEHICLE_REGS_REG, VEHICLE_REGS_BRAND);
//	});
//});
//
//function updateInventory(obj, reg, brand) {
//	
//	ajaxObj = {  
//			type: "PUT",
//			url: "http://localhost:7001/com.vehicle.rest/api/v3/inventory/" + reg + "/" + brand,
...
//				'<td class="VEHICLE_REGS_FIRST_REG">' + param.VEHICLE_REGS_FIRST_REG + '</td>' +
